...
2. 디버그 버전을 다운로드하려면 아래 링크에서 `lumos-client-dist-debug.zip`을 받으면 됩니다.
   - https://github.com/pnu-lumos/lumos-client/releases/latest/download/lumos-client-dist-debug.zip
...
- `lumos-client-dist-debug.zip` (최신 디버그 결과물 고정 파일명)
